...
from webapp.views import todolist_view, todolist_detail, todolist_delete, todolist_create, todolist_update
...
urlpatterns = [
    ...
    path('detail/<int:pk>/update/', todolist_update, name="update"),
